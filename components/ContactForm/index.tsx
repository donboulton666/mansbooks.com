              ...
              <div className="px-4 py-5 text-slate-200 sm:p-6">
                ...
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-6">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-slate-800 bg-slate-900 pl-3 pr-3">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
              ...
              <div className="inline-flex px-4 py-3 sm:px-6">
                <div className="mx-auto space-x-1 overflow-hidden p-1">
                  <span className="group relative flex items-center text-slate-200">
                    <button
                      type="submit"
                      className="rounded-md py-2 px-4 text-slate-200 shadow-lg bg-slate-900 hover:shadow-slate-800/50"
                    >
                      Send
                    </button>
                    <button
