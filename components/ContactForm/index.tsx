...
const ContactForm: FC<ContactFormProps> = props => {
  ...
  return (
    <div className="-pt-2 mb-14 lg:col-span-2 lg:mt-0">
              ...
              <div className="px-4 py-5 text-slate-200 sm:p-6">
                <div className="-mx-3 mb-6 flex flex-wrap">
                  <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-800 bg-gray-800 pl-3 pr-3 text-gray-900">
                        <svg
                          ...
                          stroke-width="1.5"
                          stroke="currentColor"
                          className="h-5 w-5 text-wine-300"
                        >
                          <path
                      ...
                      <input
                        className="mb-3 block w-full appearance-none rounded border-slate-800 bg-slate-900 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-200 focus:border-fuchsia-500 focus:outline-none focus:ring-slate-500 sm:text-sm"
                        id="firstName"
                        name="firstName"
                        type="text"
                  ...
                  <div className="w-full px-3 md:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="block w-full appearance-none rounded border-slate-800 bg-slate-900 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-200 focus:border-fuchsia-500 focus:outline-none focus:ring-slate-500 dark:border-slate-900 dark:bg-slate-900 dark:text-slate-200 sm:text-sm"
                        id="lastName"
                        name="lastName"
                        type="text"
                ...
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-6">
                    <label
                      htmlFor="userName"
                      className="mb-2 block text-xs font-bold uppercase tracking-wide text-slate-200 dark:text-slate-400"
                    >
                      User Name
                    </label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="mt-1 block w-full rounded-md border-slate-800 bg-slate-900 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-200 shadow-sm focus:border-fuchsia-500 focus:ring-slate-500 dark:bg-slate-900 dark:text-slate-400 sm:text-sm"
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        id="message"
                        name="message"
                        className="mt-1 block w-full rounded-md border-slate-800 bg-slate-900 p-2.5 pl-14 text-slate-200 caret-blue-500 shadow-sm focus:border-fuchsia-500 focus:caret-indigo-500 focus:ring-slate-500 dark:border-slate-900 dark:bg-slate-900 dark:text-slate-200 sm:text-sm"
                        rows={5}
                        name="text"
                  ...
                  <span className="group relative flex items-center text-slate-200">
                    ...
                    <div className="ml-2 block flex items-center">
                      <input
                        ...
                        className={`ml-1 h-6 w-6 rounded border-wine-400 bg-wine-400 ring-offset-wine-400 focus:ring-2 focus:ring-wine-200 
                        ${errors.acceptTerms ? 'is-invalid' : ''}`}
                      />
                      <label
                        htmlFor="acceptTerms"
                        className="ml-3 block text-xs font-bold uppercase tracking-wide text-slate-200 dark:text-slate-300"
                      >
                        <Link
                          href="/blog/privacy/"
              ...
              <div className="float-right mt-4 mr-8">
                <span className="md:ml-10">
                  ...
                  >
                    ...
                    <span className="ml-1 mt-2 text-slate-200 dark:text-slate-300">Netlify</span>
                  </a>
                </span>
                <span className="ml-2">
                  <a
                  ...
                  >
                    <Image
                      ...
                      loading="lazy"
                    />
                    <span className="ml-1 mt-2 text-slate-200 dark:text-slate-300">React Hook Forms</span>
                  </a>
                </span>
              </div>
            </div>
