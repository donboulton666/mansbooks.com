    ...
    <>
      ...
      <Layout>
        ...
        <div className="mb-10 px-4 py-6 sm:p-6 md:px-4 md:py-10">
          <div className="mx-auto grid max-w-5xl grid-cols-1 lg:max-w-5xl lg:grid-cols-2 lg:gap-x-10">
            ...
            <div className="grid grid-cols-3 place-items-center gap-4">
              ...
              <a href="https://www.youtube.com/watch?v=1U6WY_z8Vu8">
                <Image
                  ...
                  width={384}
                  height={384}
                  className="m-auto h-96 w-96 justify-center rounded-full object-center align-middle"
                  loading="lazy"
                />
              </a>
