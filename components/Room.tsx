...
const Room = () => {
  ...
  return (
    <div className="absolute left-1/2 top-3/4 mb-24 mt-4 flex w-11/12 -translate-x-1/2 -translate-y-1/2 flex-col items-center space-y-4 p-8 pb-60 text-slate-300 shadow-lg md:w-3/4 lg:w-11/12">
