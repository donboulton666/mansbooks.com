          ...
          <div className="px-4 py-5 text-slate-200 sm:p-6">
            <div className="-mx-3 mb-6 flex flex-wrap">
              <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                <label className="mb-2 block text-xs font-bold uppercase tracking-wide text-slate-200">
                  First Name
                </label>
                <div className="relative">
                  <div className="text-slate-200 pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-slate-800 bg-slate-900 pl-3 pr-3 text-slate-200 ">
                    <svg
              ...
              <div className="w-full px-3 md:w-1/2">
                ...
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-slate-800 bg-slate-900 pl-3 pr-3 text-slate-200">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
            ...
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-6">
                ...
                <div className="relative">
                  <div className="text-slate-200 pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-slate-800 bg-slate-900 pl-3 pr-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <div className="col-span-6">
                ...
                <div className="relative">
                  ...
                  <input type="text" className="mt-1 block w-full rounded-md border-slate-800 bg-slate-800 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-200 shadow-sm focus:border-blue-500 focus:ring-slate-500 sm:text-sm" name={subject} required="true" />
                </div>
              </div>
          ...
          <div className="inline-flex px-4 py-3 sm:px-6">
            <div className="mx-auto space-x-1 overflow-hidden p-1">
              <span className="group relative flex items-center text-slate-200">
                <button
                  type="submit"
                  className="rounded-md bg-slate-900 py-2 px-4 text-slate-200 shadow-lg hover:shadow-slate-800/50"
                >
                  Send
                </button>
                <button
                ...
                <div className="ml-2 flex items-center">
                  ...
                  <label className="ml-3 block text-xs font-bold uppercase tracking-wide text-slate-200">
                    <Link
                      href="/privacy"
            ...
            <span className="md:ml-10">
              ...
              >
                <svg
                  ...
                  width="40px"
                  height="40px"
                  className="inline-flex text-slate-200"
                >
                  <defs>
                    <radialGradient
                      id="a"
                ...
                <span className="ml-1 mt-2 text-slate-200">Netlify</span>
              </a>
            </span>
            <span className="ml-2">
              <a
              ...
              >
                <Image
                  ...
                  loading="lazy"
                />
                <span className="ml-1 mt-2 text-slate-200">
                  React Hook Forms
                </span>
              </a>
            </span>
